package com.example.iopensopositivo
...
class MainActivity : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
                ...
                //Toast.makeText(this, "Pienso positivo", Toast.LENGTH_LONG).show()
                Log.i("com.example.prueba", "IoPP Loading")
        }
        ...
        fun goTo(view: View){
                if(textInput.text.isNullOrEmpty()){
                        ...
                        if(num < database.size - 1){
                                texto.text = database[num]
                                posicion = num
                        }else{
                                Toast.makeText(this, "Error: el indice esta fuera del arreglo", Toast.LENGTH_LONG).show()
                        }
                }
        }
